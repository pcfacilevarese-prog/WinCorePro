...
// Limite caratteri inviati a Groq. llama-3.3-70b-versatile ha una finestra di
// contesto di 128k token (~500k caratteri), quindi 24000 caratteri (~6000 token)
// è un margine ampio che copre praticamente qualsiasi CV, incluse le sezioni
// finali come "Lingue" e "Patente/disponibilità" che in precedenza venivano
// tagliate fuori dal vecchio limite di 8000 caratteri.
const LIMITE_CARATTERI_TESTO_CV = 24000;
